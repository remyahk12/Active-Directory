...
/Azure-DC-Setup
│── /scripts
│   ├── create-resources.ps1  # PowerShell script for deployment
│   ├── setup-domain.ps1       # AD DS installation script
│── README.html                # Documentation
│── main.tf                    # (Optional) Terraform script
│── main.bicep                 # (Optional) Bicep script
│── .gitignore
        </pre>
    </div>
    ...
    <div class="section">
        ...
        <p>📅 <b>Last Updated:</b> YYYY-MM-DD</p>
        <p>💡 Found an issue? Open an <b>Issue</b> on GitHub.</p>
        <p>🔥 Want to contribute? Submit a <b>Pull Request</b>.</p>
    </div>
